 ...
 */
CGunBarrel::CGunBarrel(void)
	: cGroundMap(NULL)
	, eTierLevel(NOTIER)
{
	// Set the default position to the origin
	//vec3Position = glm::vec3(0.0f, 0.0f, 0.0f);
	//vec3Position = cPlayer3D->GetPosition();
 ...
 */
CGunBarrel::CGunBarrel(	const glm::vec3 vec3Position,
 ...
 */
bool CGunBarrel::Init(void)
{
	// Check if the shader is ready
	if (!cShader)
	{
		cout << "CGunBarrel::Init(): The shader is not available for this class instance." << endl;
		return false;
	}
	...
	iTextureID = LoadTexture("Images/Scene3D_BarrelTexture.jpg");
	if (iTextureID == 0)
	{
 ...
 */
void CGunBarrel::SetModel(glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CGunBarrel::SetView(glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CGunBarrel::SetProjection(glm::mat4 projection)
{
...
*/
void CGunBarrel::Update(const double dElapsedTime)
{
}
void CGunBarrel::AddAmmo(void)
{
...
*/
void CGunBarrel::ActivateCollider(Shader* cLineShader)
{
...
*/
void CGunBarrel::PreRender(void)
{
	// Draw this as last
...
*/
void CGunBarrel::PostRender(void)
{
...
void CGunBarrel::SetTierLevel(const TIERLEVEL eStatus)
{
	eTierLevel = eStatus;
}
CGunBarrel::TIERLEVEL CGunBarrel::GetTierLevel(void) const
{
	return eTierLevel;
}