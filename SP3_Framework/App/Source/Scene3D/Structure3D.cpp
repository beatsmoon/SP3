...
bool CStructure3D::Init(void)
{
	...
	{
		// load and create a texture 
		iTextureID = LoadTexture("Images/Scene3D_Structure_01.tga");
		if (iTextureID == 0)
		{
			cout << "Unable to load Images/Scene3D_Structure_01.tga" << endl;
			return false;
		}
	}
	break;
