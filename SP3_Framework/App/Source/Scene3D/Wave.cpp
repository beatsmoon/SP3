...
void CWave::StartWave(int waveNumber)
{
	...
	for (int i = 0; i < waveNumber + 3; ++i)
	{
		...
		cEnemy3DType1 = new CEnemy3D(glm::vec3(CPlayer3D::GetInstance()->GetPosition().x + 15 + Math::RandFloatMinMax(-10.0f, 10.0f), 0.5f, CPlayer3D::GetInstance()->GetPosition().z + 15 + Math::RandFloatMinMax(-10.0f, 10.0f)), k);
...
void CWave::SpawnBoss(void)
{
	...
	case 1: // boss 1
	{
		cBoss3D = new CBoss3D(glm::vec3(CPlayer3D::GetInstance()->GetPosition().x + 15 + Math::RandFloatMinMax(-10.0f, 10.0f), 0.5f, CPlayer3D::GetInstance()->GetPosition().z + 15 + Math::RandFloatMinMax(-10.0f, 10.0f)), 0);
	...
	case 2:  // boss 2
	{
		cBoss3D = new CBoss3D(glm::vec3(CPlayer3D::GetInstance()->GetPosition().x + 15 + Math::RandFloatMinMax(-10.0f, 10.0f), 0.5f, CPlayer3D::GetInstance()->GetPosition().z + 15 + Math::RandFloatMinMax(-10.0f, 10.0f)), 1);
		cBoss3D->SetShader(cShader);
		cBoss3D->Init();
		cBoss3D->SetHealth(cBoss3D->GetHealth() + ((wave - 1) * 200));
		cBoss3D->ActivateCollider(cSimpleShader);
	...
	case 0:  // boss 3
	{
		cBoss3D = new CBoss3D(glm::vec3(CPlayer3D::GetInstance()->GetPosition().x + 15 + Math::RandFloatMinMax(-10.0f, 10.0f), 0.5f, CPlayer3D::GetInstance()->GetPosition().z + 15 + Math::RandFloatMinMax(-10.0f, 10.0f)), 2);
		cBoss3D->SetShader(cShader);
		cBoss3D->Init();
		cBoss3D->SetHealth(cBoss3D->GetHealth() + ((wave - 1) * 200));
		cBoss3D->ActivateCollider(cSimpleShader);
	...
	default: // last boss 
	{
		for (int i = 0; i < 3; i++)
		{
			CBoss3D* cBoss3D = new CBoss3D(glm::vec3(CPlayer3D::GetInstance()->GetPosition().x + 15 + Math::RandFloatMinMax(-10.0f, 10.0f), 0.5f, CPlayer3D::GetInstance()->GetPosition().z + 15 + Math::RandFloatMinMax(-10.0f, 10.0f)), i);
			cBoss3D->SetShader(cShader);
			cBoss3D->Init();
